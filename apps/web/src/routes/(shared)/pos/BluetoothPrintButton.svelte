<script lang="ts">
	...
	async function cetakStrukBluetooth() {
		...
		try {
			...
			// Hapus filter yang ketat agar menampilkan SEMUA perangkat di sekitar
			// Hal ini untuk mengecek apakah masalahnya ada di filter atau API Bluetooth-nya
			...
			// Optional: Anda bisa mengecek services yang tersedia dulu (berguna jika UUID printer Anda berbeda)
			// const services = await server.getPrimaryServices();
			// console.log("Services yang tersedia: ", services.map(s => s.uuid));
