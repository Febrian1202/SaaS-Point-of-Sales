...
export const transactionRoutes = new Elysia({
  ...
  detail: { tags: ["Transaction Routes"] },
})
  .error({
  ...
  .get(
    ...
    },
    {
      ...
      detail: {
        ...
        description:
          "Mengambil daftar riwayat transaksi penjualan ritel toko. Endpoint ini biasanya digunakan pada halaman riwayat mesin kasir dan mendukung *pagination* serta pencarian data berdasarkan *query parameter*.",
      },
    },
  )
  .get(
    ...
    },
    {
      ...
      detail: {
        ...
        description:
          "Mengambil informasi detail dari satu transaksi spesifik berdasarkan ID (UUID). Endpoint ini akan mengembalikan data lengkap termasuk daftar barang (item) yang dibeli, harga satuan, dan total belanja untuk keperluan pencetakan struk ulang.",
      },
    },
  )
  .use(
  ...
  .post(
    ...
    },
    {
      ...
      detail: {
        ...
        description:
          "Membatalkan transaksi yang sudah terjadi (*void*). Endpoint ini akan mengubah status transaksi menjadi dibatalkan dan secara otomatis **mengembalikan stok barang** ke jumlah semula. \n\n🚨 **Perhatian:** Endpoint ini dilindungi oleh `adminGuard` dan hanya bisa diakses oleh *user* dengan *role* **Admin**.",
      },
    },
  );
