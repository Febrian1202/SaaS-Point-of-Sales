  ...
  .get(
    ...
    },
    {
      ...
      detail: {
        ...
        description:
          "Mengambil daftar seluruh kategori produk yang terdaftar di toko. Endpoint ini sangat ringan dan mendukung pencarian nama kategori menggunakan parameter *query* `search`.",
      },
    },
  )
  .get(
    ...
    },
    {
      ...
      detail: {
        ...
        description:
          "Mengambil informasi detail spesifik dari satu kategori berdasarkan ID (UUID). Berguna jika kamu perlu memvalidasi apakah sebuah kategori masih ada di database.",
      },
    },
  )
  .use(adminGuard)
  .post(
    ...
    },
    {
      ...
      detail: {
        ...
        description:
          "Menambahkan kategori produk baru. Nama kategori harus unik di dalam satu toko.\n\n🚨 **Perhatian:** Hanya bisa diakses oleh **Admin**.",
      },
    },
  )
  .patch(
    "/:id",
    async ({ params: { id }, tenantId, body }) => {
    ...
    },
    {
      ...
      detail: {
        ...
        description:
          "Mengubah informasi kategori yang sudah ada.\n\n🚨 **Perhatian:** Hanya bisa diakses oleh **Admin**.",
      },
    },
  )
  .delete(
    ...
    },
    {
      ...
      detail: {
        ...
        description:
          "Menghapus kategori produk. Kategori tidak bisa dihapus jika masih ada produk yang menggunakannya.\n\n🚨 **Perhatian:** Hanya bisa diakses oleh **Admin**.",
      },
    },
  );
