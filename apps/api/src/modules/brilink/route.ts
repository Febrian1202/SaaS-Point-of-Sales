...
export const brilinkRoutes = new Elysia({
  prefix: "/brilink",
  name: "Brilink Routes",
  tags: ["Brilink Routes"],
})
  ...
  .get(
    ...
    },
    {
      ...
      detail: {
        ...
        description:
          "Mengambil daftar riwayat transaksi agen BRI Link milik toko. Mendukung filter berdasarkan tanggal dan jenis transaksi (seperti transfer, tarik tunai, pembayaran, dll) untuk keperluan audit kasir.",
      },
    },
  )
  .get(
    ...
    },
    {
      ...
      detail: {
        ...
        description:
          "Menampilkan ringkasan akumulasi transaksi BRI Link berdasarkan tanggal tertentu. Endpoint ini akan mengembalikan data total volume transaksi dan **total keuntungan (komisi agen)** yang dikelompokkan berdasarkan jenis transaksi.",
      },
    },
  )
  .get(
    ...
    },
    {
      ...
      detail: {
        ...
        description:
          "Mengambil informasi spesifik dan lengkap dari satu transaksi BRI Link berdasarkan ID (UUID). Menampilkan rincian seperti nominal uang pelanggan, biaya admin bank, komisi agen bersih, dan nomor referensi struk.",
      },
    },
  )
  .use(
  ...
  .post(
    ...
    },
    {
      ...
      detail: {
        ...
        description:
          "Mencatat transaksi agen BRI Link baru yang dilakukan oleh kasir. Endpoint ini memisahkan pencatatan antara uang pelanggan, biaya admin, dan komisi agen. Terdapat perlindungan *rate limit* (10 detik) untuk mencegah terjadinya pencatatan ganda akibat koneksi lambat.",
      },
    },
  )
  ...
  .post(
    ...
    },
    {
      ...
      detail: {
        ...
        description:
          "Membatalkan pencatatan transaksi BRI Link jika terjadi kesalahan input oleh kasir atau transaksi gagal di mesin EDC. \n\n🚨 **Perhatian:** Endpoint ini dilindungi ketat oleh `adminGuard` dan **hanya bisa diakses oleh Admin**.",
      },
    },
  );
